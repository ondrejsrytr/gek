                        ...
                        <table id="main_table" class="table table-striped table-bordered overflow-auto">
                            ...
                            for ($i = 0; $i < $pocet; $i++) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="vydat.php" method="post"><input type="hidden" name="clanekid" value="<?= $result[$i]['id'] ?>"><button type="submit" class="btn btn-link">Vydat</button></form>
                                    </td>
                                    <td>
                                        <form action="smazat.php" method="post"><input type="hidden" name="clanekid" value="<?= $result[$i]['id'] ?>"><button type="submit" class="btn btn-link">Smazat</button></form>
                                    </td>
                                    <td>
                                        <form action="prehodnotit.php" method="post"><input type="hidden" name="clanekid" value="<?= $result[$i]['id'] ?>"><button type="submit" class="btn btn-link">Přehodnotit</button></form>
                                    </td>
